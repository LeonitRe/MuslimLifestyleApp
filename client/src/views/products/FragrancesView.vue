...
const product = async () => {
  const response = await axios.get('http://localhost:5080/products?category=fragrances')
...
const filteredProducts = computed(() => {
  return prd.value.filter((p) => {
    ...
    const isCategoryMatch = category === 'fragrances'
  ...
  <FilterBox>
    <Filter filter="Filter">
      <Item>
        ...
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Attars')">
            Attars
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Brands')">
            Brands
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Burners')">
            Burners
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Incense')">
            Incense
          </button>
        </li>
      </Item>
