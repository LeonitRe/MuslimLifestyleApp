...
const product = async () => {
  const response = await axios.get('http://localhost:5080/products?category=accessories')
...
const filteredProducts = computed(() => {
  return prd.value.filter((p) => {
    ...
    const isCategoryMatch = category === 'accessories'
  ...
  <FilterBox>
    <Filter filter="Filter">
      <Item>
        ...
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Hijabcaps')">
            Hijabcaps
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Hijabscarf')">
            Hijabscarf
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Hijabseelve')">
            Hijabseelve
          </button>
        </li>
      </Item>
