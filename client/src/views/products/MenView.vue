...
const product = async () => {
  const response = await axios.get('http://localhost:5080/products?category=men')
...
const filteredProducts = computed(() => {
  return prd.value.filter((p) => {
    ...
    const isCategoryMatch = category === 'men'
  ...
  <FilterBox>
    <Filter filter="Filter">
      <Item>
        ...
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Bishts')">
            Bishts
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Jalabyas')">
            Jalabyas
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Kufi')">Kufi</button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Thobes')">
            Thobes
          </button>
        </li>
      </Item>
