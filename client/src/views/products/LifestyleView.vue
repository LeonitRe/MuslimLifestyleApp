...
const product = async () => {
  const response = await axios.get('http://localhost:5080/products?category=lifestyle')
...
const filteredProducts = computed(() => {
  return prd.value.filter((p) => {
    ...
    const isCategoryMatch = category === 'lifestyle'
  ...
  <FilterBox>
    <Filter filter="Filter">
      <Item>
        ...
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Eidecor')">
            Eidecor
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Prayer')">
            Prayer
          </button>
        </li>
        <li>
          <button type="button" class="btn btn-light" @click="setProductType('Ramadandecor')">
            Ramadandecor
          </button>
        </li>
      </Item>
